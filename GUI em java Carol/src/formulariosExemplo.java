// exemplo 2 ( formularios - labels, campos, botoes, layout )

import javax.swing.*;
import java.awt.*;

public class formulariosExemplo extends JFrame {
    private JTextField tfNome, tfEmail, tfIdade;

    public formulariosExemplo() {
        super("Formulario - GridBagLayout");
        ...
        btnSalvar.addActionListener(e -> {
            String msg = String.format("Nome: %s%nEmail: %s%nIdade: %s", tfNome.getText(), tfEmail.getText(), tfIdade.getText());
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(() -> new formulariosExemplo().setVisible(true));
    }
}
